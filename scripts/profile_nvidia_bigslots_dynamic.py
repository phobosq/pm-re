...
import argparse,bisect,struct,re
import pefile
...
def main():
 ...
 # collect references/writers to selected RIP-indirect slots
 ...
 for tgt in TARGETS:
  ...
  lines.append('')
 # find code writes to each slot and nearby direct GetProcAddress-style call patterns
