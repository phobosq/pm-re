...
Scope: NVIDIA child vtable large methods only.
...
### ref `0x001D7647` in `0x001D763F..0x001D7726`
...
### ref `0x001E5202` in `0x001E5160..0x001E6C7D`
...
0x001E5249: mov byte ptr [rbp + 0x299], cl
0x001E524F: movsx ecx, byte ptr [rbp + 0x299]
```

### ref `0x001E6D22` in `0x001E6C80..0x001E8A0A`
...
0x001E6D69: mov byte ptr [rbp + 0x2d9], cl
0x001E6D6F: movsx ecx, byte ptr [rbp + 0x2d9]
```

### ref `0x001FE57F` in `0x001FE160..0x001FE730`
...
### ref `0x001E0F3F` in `0x001E0EC0..0x001E1F65`
...
0x001E0F79: lea rdx, [rbp + 0x4e4]
0x001E0F80: add rdx, rcx
```

### ref `0x001E11BA` in `0x001E0EC0..0x001E1F65`
...
### ref `0x001E1FEF` in `0x001E1F70..0x001E2FD9`
...
0x001E2029: lea rdx, [rbp + 0x4f4]
0x001E2030: add rdx, rcx
```

### ref `0x001E226A` in `0x001E1F70..0x001E2FD9`
...
### ref `0x001E59FD` in `0x001E5160..0x001E6C7D`
...
### ref `0x001E5CC9` in `0x001E5160..0x001E6C7D`
...
### ref `0x001E77DE` in `0x001E6C80..0x001E8A0A`
...
### ref `0x001E7AA9` in `0x001E6C80..0x001E8A0A`
...
### ref `0x001FE5D9` in `0x001FE160..0x001FE730`
...
### ref `0x001E1199` in `0x001E0EC0..0x001E1F65`
...
### ref `0x001E2249` in `0x001E1F70..0x001E2FD9`
...
### ref `0x001E5CA8` in `0x001E5160..0x001E6C7D`
...
### ref `0x001E7A88` in `0x001E6C80..0x001E8A0A`
...
### ref `0x001FE5EB` in `0x001FE160..0x001FE730`
...
### ref `0x001E3029` in `0x001E2FE0..0x001E3E34`
...
### ref `0x001E30B8` in `0x001E2FE0..0x001E3E34`
...
### ref `0x001E8A62` in `0x001E8A10..0x001E9930`
...
### ref `0x001E8B20` in `0x001E8A10..0x001E9930`
...
### ref `0x001FE633` in `0x001FE160..0x001FE730`
...
### ref `0x001E3037` in `0x001E2FE0..0x001E3E34`
...
### ref `0x001E3393` in `0x001E2FE0..0x001E3E34`
...
### ref `0x001E8A70` in `0x001E8A10..0x001E9930`
...
0x001E8AA4: lea rax, [rdi + 0x13c]
0x001E8AAB: lea rcx, [rsp + 0x20]
0x001E8AB0: cmp dword ptr [rax], ebx
0x001E8AB2: cmovl rcx, rax
```

### ref `0x001E8D8C` in `0x001E8A10..0x001E9930`
...
### ref `0x001FE645` in `0x001FE160..0x001FE730`
