# Slot +0x68 wrappers/tailcalls

Includes indirect CALL and JMP through vtable slot +0x68.

hits: `23`

## `call` `0x0004586F` in `0x00045840..0x000458A2`

```asm
0x00045821: mov rax, rbx
0x00045824: mov rcx, qword ptr [rsp + 0x58]
0x00045829: xor rcx, rsp
0x0004582C: call 0x1403b24c0
0x00045831: add rsp, 0x60
0x00045835: pop rdi
0x00045836: pop rsi
0x00045837: pop rbx
0x00045838: ret
...
## `call` `0x00047AA9` in `0x00047A60..0x00047B10`

```asm
0x00047A4D: jne 0x140047a57
0x00047A4F: mov al, 1
0x00047A51: add rsp, 0x30
0x00047A55: pop rbx
0x00047A56: ret
0x00047A57: xor al, al
...
## `call` `0x00131B75` in `0x001312E0..0x00131E84`
...
## `call` `0x00136F0A` in `0x00136D30..0x0013722D`

```asm
0x00136E96: jne 0x140136eba
0x00136E98: mov rcx, rdi
0x00136E9B: call 0x140135560
0x00136EA0: mov rcx, rdi
0x00136EA3: call 0x140135850
0x00136EA8: mov rcx, rdi
...
## `call` `0x0014BA6C` in `0x0014BA60..0x0014BA78`

```asm
0x0014BA2F: int3
0x0014BA30: push rbx
0x0014BA32: sub rsp, 0x20
0x0014BA36: mov rax, qword ptr [rcx]
0x0014BA39: mov rbx, rcx
0x0014BA3C: call qword ptr [rax + 0x50]
...
## `jmp` `0x0016E0C2` in `0x00000000..0x00000000`

```asm
0x0016E07F: mov qword ptr [rcx + 8], rax
0x0016E083: mov qword ptr [rcx + 0x10], rax
0x0016E087: mov dword ptr [rsp + 0x20], 1
0x0016E08F: call 0x14016d730
0x0016E094: nop
0x0016E095: jmp 0x14016e09c
0x0016E097: mov rbx, qword ptr [rsp + 0x70]
0x0016E09C: mov rax, rbx
0x0016E09F: add rsp, 0x60
0x0016E0A3: pop rbx
0x0016E0A4: ret
0x0016E0A5: int3
0x0016E0A6: int3
...
0x0016E0AE: int3
0x0016E0AF: int3
0x0016E0B0: mov rcx, qword ptr [rcx + 0x80]
0x0016E0B7: test rcx, rcx
0x0016E0BA: jne 0x14016e0bf
0x0016E0BC: xor al, al
0x0016E0BE: ret
0x0016E0BF: mov rax, qword ptr [rcx]
0x0016E0C2: jmp qword ptr [rax + 0x68]
0x0016E0C6: int3
0x0016E0C7: int3
0x0016E0C8: int3
0x0016E0C9: int3
...
## `call` `0x001F89D5` in `0x001F7F40..0x001FB9C1`

```asm
0x001F8942: lea r9, [rbp - 0x64]
0x001F8946: lea r8, [rbp - 0x28]
0x001F894A: lea rdx, [rbp - 0x60]
0x001F894E: mov rcx, rax
0x001F8951: call 0x1401ed410
0x001F8956: nop
...
## `call` `0x001F94A5` in `0x001F7F40..0x001FB9C1`
...
## `call` `0x002204FD` in `0x00220280..0x00220BA4`

```asm
0x00220483: je 0x14022097a
0x00220489: test al, al
0x0022048B: je 0x14022097a
0x00220491: mov rcx, rdi
0x00220494: call 0x140391b24
0x00220499: test eax, eax
...
## `call` `0x002B1450` in `0x002B13E0..0x002B14B5`
...
## `call` `0x002B1484` in `0x002B13E0..0x002B14B5`
...
## `call` `0x002B16D1` in `0x002B1630..0x002B170A`
...
## `call` `0x002B1DA1` in `0x002B1CB0..0x002B2005`
...
## `call` `0x002B1F5A` in `0x002B1CB0..0x002B2005`
...
## `call` `0x002BCA96` in `0x002BCA20..0x002BCD6F`
...
## `call` `0x002BCCBD` in `0x002BCA20..0x002BCD6F`
...
## `call` `0x002BD595` in `0x002BD450..0x002BD673`
...
## `call` `0x002BD658` in `0x002BD450..0x002BD673`
...
## `call` `0x002BD9C8` in `0x002BD8A0..0x002BDBE1`
...
## `call` `0x002BD9F8` in `0x002BD8A0..0x002BDBE1`
...
## `call` `0x002CAE09` in `0x002CAD4B..0x002CAEF7`
...
## `call` `0x002CAE21` in `0x002CAD4B..0x002CAEF7`
...
## `call` `0x0037FFE4` in `0x0037F860..0x00380004`
